...
@pytest.mark.asyncio
async def test_create_conversation_success(client, mock_assistant_service):
...
@pytest.mark.asyncio
async def test_create_conversation_missing_user_id(client):
...
@pytest.mark.asyncio
async def test_get_conversation_success(client, mock_assistant_service):
...
@pytest.mark.asyncio
async def test_send_message_success(client, mock_assistant_service):
...
@pytest.mark.asyncio
async def test_get_recommendations_success(client, mock_learning_service):
    ...
    mock_recommendations = [
        Recommendation(
            ...
            content='Consider rebalancing your portfolio'
        )
    ]
