...
### 137.1 Postgres Tax-Free Accumulation Ledger `[ ]`
...
|-----------|-----------|--------|
| Migration | `migrations/137_education_ledger.sql` | `[ ]` |
| Ledger Service | `services/education/ledger_service.py` | `[ ]` |
| Basis Tracker | `services/tax/basis_tracker_529.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Growth Chart | `frontend2/src/components/Education/GrowthChart.jsx` | `[ ]` |
| Withdrawal Wizard | `frontend2/src/components/Education/WithdrawalWizard.jsx` | `[ ]` |

---

### 137.2 Qualified Education Expense Verifier `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Expense Verifier | `services/compliance/expense_verifier.py` | `[ ]` |
| IRS Limit Config | `config/irs_education_limits.py` | `[ ]` |

---

### 137.3 Non-Qualified Tax & Penalty Calculator `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Penalty Calculator | `services/tax/penalty_calculator_529.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Penalty Estimate | `frontend2/src/components/Education/PenaltyEstimate.jsx` | `[ ]` |

---

### 137.4 Neo4j Grandparent vs. Parent Ownership `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Ownership Graph | `services/neo4j/529_ownership_graph.py` | `[ ]` |
| FAFSA Impact Calc | `services/education/fafsa_impact.py` | `[ ]` |

---

### 137.5 State Tax Credit Mapper `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| State Tax Mapper | `services/tax/state_tax_mapper.py` | `[ ]` |
| Credit Optimizer | `services/planning/credit_optimizer.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py 529 balance` | Show principal/earnings | `[ ]` |
| `python cli.py 529 verify-expense` | Check if expense qualifies | `[ ]` |
| `python cli.py 529 fafsa-impact` | Calculate FAFSA impact | `[ ]` |
