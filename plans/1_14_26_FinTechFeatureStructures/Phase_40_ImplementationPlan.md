...
| Component | File Path | Status |
|-----------|-----------|--------|
| Sector Monitor | `services/real_estate/sector_risk.py` | `[ ]` |

---

### 40.4 DRIP Automation Support `[ ]`

**Acceptance Criteria**: Verify that automated dividend reinvestment (DRIP) is supported through the brokerage API settings.

| Component | File Path | Status |
|-----------|-----------|--------|
| DRIP Manager | `services/broker/drip_manager.py` | `[ ]` |

---

### 40.5 D3.js Physical Asset Map `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Property Map | `frontend2/src/components/Maps/REITLoc.jsx` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py reit list-yields` | Show top yields | `[ ]` |
| `python cli.py reit project-snowball` | 5yr forecast | `[ ]` |
