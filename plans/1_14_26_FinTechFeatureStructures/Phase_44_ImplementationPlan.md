...
### 44.1 Overlapping Holdings Identifier `[ ]`
...
|-----------|-----------|--------|
| Scanner | `services/risk/overlap_scanner.py` | `[ ]` |

---

### 44.2 Tech Concentration Alert (>35%) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Tech Alert | `services/alerts/tech_concentration.py` | `[ ]` |

---

### 44.3 Negative Selection Bias Calc `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Bias Calc | `services/analysis/negative_bias.py` | `[ ]` |

---

### 44.4 De-concentration Suggestions `[ ]`

**Acceptance Criteria**: Implement automated suggestions. "Sell AAPL stock to reduce overlap with QQQ holdings."

| Component | File Path | Status |
|-----------|-----------|--------|
| Suggestion Engine | `services/strategies/deconcentrate.py` | `[ ]` |

### 44.5 Compliance Audit Log `[ ]`

**Acceptance Criteria**: Log all 'Index Overlap' alerts to the compliance audit log with sector breakdown.

| Component | File Path | Status |
|-----------|-----------|--------|
| Audit Log | `services/logging/concentration_log.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py risk scan-overlap` | Find dupes | `[ ]` |
| `python cli.py risk check-tech` | Mag 7 exposure | `[ ]` |
