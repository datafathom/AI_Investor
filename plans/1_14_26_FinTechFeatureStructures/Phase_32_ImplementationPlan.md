...
### 32.1 60 FPS Pip Velocity Stream (WebSockets) `[ ]`
...
|-----------|-----------|--------|
| Socket Manager | `api/sockets/pipometer.py` | `[ ]` |
| Velocity Calc | `services/market/velocity_calc.py` | `[ ]` |

---

### 32.2 'Flash Crash' Velocity Detector `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Crash Detector | `services/alerts/flash_crash.py` | `[ ]` |

---

### 32.3 React Pipometer Widget (Canvas/D3) `[ ]`

**Acceptance Criteria**: Visual gauge. Needle moves based on velocity. Color shifts Green (Fast Up) to Red (Fast Down).

| Component | File Path | Status |
|-----------|-----------|--------|
| Widget | `frontend2/src/components/Market/Pipometer.jsx` | `[ ]` |

---

### 32.4 Historical Volatility Distribution `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Distro Chart | `frontend2/src/components/Charts/VolDistribution.jsx` | `[ ]` |

---

### 32.5 Multi-Pair Support `[ ]`

**Acceptance Criteria**: Allow user to switch the Pipometer target (EURUSD, GBPJPY, XAUUSD) instantly.

| Component | File Path | Status |
|-----------|-----------|--------|
| Pair Selector | `frontend2/src/components/Market/PairSelector.jsx` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py pipometer stream` | Debug stream | `[ ]` |
| `python cli.py pipometer stats` | Show peak velocity | `[ ]` |
