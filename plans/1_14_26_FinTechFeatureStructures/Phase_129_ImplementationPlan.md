...
### 129.1 Top 10 > 40% Market Cap Detection `[ ]`
...
|-----------|-----------|--------|
| Migration | `migrations/129_index_concentration.sql` | `[ ]` |
| Concentration Detector | `services/risk/concentration_detector.py` | `[ ]` |
| HHI Calculator | `services/quantitative/hhi_calculator.py` | `[ ]` |
| Snapshot Service | `services/market/concentration_snapshot.py` | `[ ]` |
| API Endpoint | `web/api/risk/concentration.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Concentration Dashboard | `frontend2/src/components/Risk/ConcentrationDashboard.jsx` | `[ ]` |
| Top Holdings Table | `frontend2/src/components/Risk/TopHoldingsTable.jsx` | `[ ]` |
| Concentration Gauge | `frontend2/src/components/Charts/ConcentrationGauge.jsx` | `[ ]` |
| Alert Banner | `frontend2/src/components/Alerts/ConcentrationAlert.jsx` | `[ ]` |
| useConcentration Hook | `frontend2/src/hooks/useConcentration.js` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Concentration Detector | `tests/unit/test_concentration_detector.py` | `[ ]` |
| Unit: HHI Calculator | `tests/unit/test_hhi_calculator.py` | `[ ]` |
| Unit: Snapshot Service | `tests/unit/test_concentration_snapshot.py` | `[ ]` |
| Integration: Full Pipeline | `tests/integration/test_concentration_pipeline.py` | `[ ]` |
| E2E: Dashboard UI | `tests/e2e/test_concentration_dashboard.py` | `[ ]` |

---

### 129.2 Equal Weighted Rebalancing Service `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Equal Weight Rebalancer | `services/portfolio/equal_weight_rebalancer.py` | `[ ]` |
| Transaction Cost Estimator | `services/trading/transaction_cost.py` | `[ ]` |
| Rebalance Trade Generator | `services/trading/rebalance_generator.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Rebalance Preview | `frontend2/src/components/Portfolio/RebalancePreview.jsx` | `[ ]` |
| Weight Comparison Chart | `frontend2/src/components/Charts/WeightComparisonChart.jsx` | `[ ]` |
| Cost Estimate Display | `frontend2/src/components/Portfolio/CostEstimate.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Equal Weight | `tests/unit/test_equal_weight_rebalancer.py` | `[ ]` |
| Unit: Cost Estimator | `tests/unit/test_transaction_cost.py` | `[ ]` |
| Integration: Rebalance Flow | `tests/integration/test_rebalance_flow.py` | `[ ]` |

---

### 129.3 Cap Weighted vs. Fundamental Distortion Log `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Distortion Logger | `services/analysis/fundamental_distortion.py` | `[ ]` |
| Weight Comparator | `services/analysis/weight_comparator.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Distortion Heatmap | `frontend2/src/components/Charts/DistortionHeatmap.jsx` | `[ ]` |
| Distortion Log Table | `frontend2/src/components/Tables/DistortionLog.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Distortion Logger | `tests/unit/test_fundamental_distortion.py` | `[ ]` |
| Unit: Weight Comparator | `tests/unit/test_weight_comparator.py` | `[ ]` |

---

### 129.4 Neo4j Tech Concentration Node `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Tech Concentration Graph | `services/neo4j/tech_concentration_graph.py` | `[ ]` |
| Sector Weight Analyzer | `services/analysis/sector_weight_analyzer.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Tech Concentration Graph | `frontend2/src/components/Neo4j/TechConcentrationGraph.jsx` | `[ ]` |
| Sector Breakdown Chart | `frontend2/src/components/Charts/SectorBreakdown.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Tech Graph | `tests/unit/test_tech_concentration_graph.py` | `[ ]` |
| Integration: Neo4j | `tests/integration/test_tech_concentration_neo4j.py` | `[ ]` |

---

### 129.5 Diversification Repair Tool `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Diversification Repair Tool | `services/portfolio/diversification_repair.py` | `[ ]` |
| Gap Analyzer | `services/portfolio/gap_analyzer.py` | `[ ]` |
| Suggestion Generator | `services/portfolio/suggestion_generator.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Repair Tool Interface | `frontend2/src/components/Portfolio/RepairTool.jsx` | `[ ]` |
| Suggestion Cards | `frontend2/src/components/Portfolio/SuggestionCards.jsx` | `[ ]` |
| Before/After Comparison | `frontend2/src/components/Charts/BeforeAfterComparison.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Repair Tool | `tests/unit/test_diversification_repair.py` | `[ ]` |
| Unit: Gap Analyzer | `tests/unit/test_gap_analyzer.py` | `[ ]` |
| Integration: Full Repair Flow | `tests/integration/test_repair_flow.py` | `[ ]` |
| E2E: Repair Tool UI | `tests/e2e/test_repair_tool_ui.py` | `[ ]` |
...
|-------------|--------|--------------|
| 129.1 Top 10 > 40% Detection | `[ ]` | `[ ]` |
| 129.2 Equal Weight Rebalancer | `[ ]` | `[ ]` |
| 129.3 Fundamental Distortion Log | `[ ]` | `[ ]` |
| 129.4 Neo4j Tech Concentration | `[ ]` | `[ ]` |
| 129.5 Diversification Repair | `[ ]` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py concentration analyze <index>` | Analyze index concentration | `[ ]` |
| `python cli.py concentration hhi <index>` | Calculate HHI | `[ ]` |
| `python cli.py diversification repair <portfolio>` | Generate repair suggestions | `[ ]` |
| `python cli.py rebalance equal-weight <portfolio>` | Generate equal-weight rebalance | `[ ]` |
