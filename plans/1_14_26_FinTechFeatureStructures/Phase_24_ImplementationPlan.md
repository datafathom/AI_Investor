...
### 24.1 Neo4j `LIQUIDITY_ZONE` Node Schema `[ ]`
...
|-----------|-----------|--------|
| Graph Service | `services/neo4j/liquidity_graph.py` | `[ ]` |

---

### 24.2 Order Block Detection Algorithm `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| OB Detector | `services/analysis/order_blocks.py` | `[ ]` |

---

### 24.3 Zone Mitigation Tracker `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Mitigation Service | `services/analysis/zone_mitigation.py` | `[ ]` |

---

### 24.4 Nearest 3-Trap Query (<100ms) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Query Optimizer | `services/neo4j/queries/zone_queries.cql` | `[ ]` |

---

### 24.5 SearcherAgent Zone Filter `[ ]`

**Acceptance Criteria**: Integrate graph zones into SearcherAgent. DO NOT BUY if price is inside a Supply Zone.

| Component | File Path | Status |
|-----------|-----------|--------|
| Signal Filter | `services/strategies/zone_filter.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py zones detect <ticker>` | Find new zones | `[ ]` |
| `python cli.py zones list-active` | Show unmitigated | `[ ]` |
