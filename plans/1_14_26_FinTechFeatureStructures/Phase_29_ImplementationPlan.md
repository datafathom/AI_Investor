...
### 29.1 High-Resolution Equity Hypertable `[ ]`
...
|-----------|-----------|--------|
| Migration | `migrations/29_equity_curve.sql` | `[ ]` |
| Recorder | `services/performance/equity_recorder.py` | `[ ]` |

---

### 29.2 Rolling Drawdown Calculator (SQL) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| SQL Queries | `services/performance/drawdown_queries.sql` | `[ ]` |

---

### 29.3 Risk Adjustment Feedback Loop `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Risk Adjuster | `services/risk/feedback_loop.py` | `[ ]` |

---

### 29.4 D3.js 'Underwater' Chart `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Chart | `frontend2/src/components/Charts/Underwater.jsx` | `[ ]` |

---

### 29.5 Drawdown Acceleration Alert `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Acceleration Monitor | `services/alerts/dd_velocity.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py perf get-mdd` | Show max drawdown | `[ ]` |
| `python cli.py perf underwater` | Show current depth | `[ ]` |
