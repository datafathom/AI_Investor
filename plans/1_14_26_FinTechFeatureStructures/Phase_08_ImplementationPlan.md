...
|-----------|-----------|--------|
| ProtectorAgent Core | `agents/protector_agent.py` | `[ ]` |
| Prime Directive Module | `agents/directives/prime_directive.py` | `[ ]` |
| Capital Shield Service | `services/capital_shield.py` | `[ ]` |
| Risk Threshold Config | `config/risk_thresholds.py` | `[ ]` |

#### Prime Directive Rules

| Rule | Description | Priority | Status |
|------|-------------|----------|--------|
| PD-001 | Never risk more than 1% per position | Critical | `[ ]` |
| PD-002 | Freeze portfolio at 3% daily drawdown | Critical | `[ ]` |
| PD-003 | Kill individual asset at 10% loss | High | `[ ]` |
| PD-004 | No unprotected positions (stop-loss required) | Critical | `[ ]` |
| PD-005 | Preserve emergency fund moat at all times | Critical | `[ ]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Liquidation Engine | `services/liquidation_engine.py` | `[ ]` |
| Position Monitor | `services/position_monitor.py` | `[ ]` |
| Emergency Kill Service | `services/emergency_kill.py` | `[ ]` |

#### Liquidation Triggers

| Trigger | Threshold | Action | Status |
|---------|-----------|--------|--------|
| Stop Loss Hit | Price <= SL | Immediate liquidation | `[ ]` |
| Asset Kill Switch | -10% from entry | Full position close | `[ ]` |
| Portfolio Freeze | -3% daily | Close all new entries | `[ ]` |
| Margin Danger | < 15% buffer | De-leverage sequence | `[ ]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Veto Service | `services/veto_service.py` | `[ ]` |
| Volatility Monitor | `services/volatility_monitor.py` | `[ ]` |
| Signal Interceptor | `services/signal_interceptor.py` | `[ ]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Drawdown Calculator | `services/drawdown_calculator.py` | `[ ]` |
| Equity Curve Tracker | `services/equity_tracker.py` | `[ ]` |
| Kafka Consumer (Warden) | `services/kafka/warden_consumer.py` | `[ ]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Intervention Logger | `services/neo4j/intervention_logger.py` | `[ ]` |
| Graph Queries | `services/neo4j/warden_queries.py` | `[ ]` |
...
|-------------|--------|--------------|
| 8.1 Prime Directive | `[ ]` | `[ ]` |
| 8.2 Autonomous Liquidation | `[ ]` | `[ ]` |
| 8.3 Veto Mechanism | `[ ]` | `[ ]` |
| 8.4 Drawdown Telemetry | `[ ]` | `[ ]` |
| 8.5 Neo4j Mapping | `[ ]` | `[ ]` |
