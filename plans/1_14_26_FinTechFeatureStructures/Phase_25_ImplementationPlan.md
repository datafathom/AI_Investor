...
### 25.1 'Peter Lynch Legend' Metric (60% Baseline) `[ ]`
...
|-----------|-----------|--------|
| Metric Calculator | `services/analysis/lynch_metric.py` | `[ ]` |

---

### 25.2 Expectancy Calculator (RR vs WinRate) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Expectancy Engine | `services/analysis/expectancy.py` | `[ ]` |

---

### 25.3 Periodic Survival Scorecard Generator `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Scorecard Gen | `services/reporting/survival_score.py` | `[ ]` |

---

### 25.4 Alpha Attribution (Luck vs. Edge) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Attribution | `services/analysis/alpha_attribution.py` | `[ ]` |

---

### 25.5 Monte Carlo Projection of Current Stats `[ ]`

**Acceptance Criteria**: Project current win-rate/RR forward 1000 trades to check for "Ruin" probability.

| Component | File Path | Status |
|-----------|-----------|--------|
| Projection Sim | `services/simulation/current_stats_sim.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Expectancy Chart | `frontend2/src/components/Analysis/ExpectancyCurve.jsx` | `[ ]` |
| Edge Dashboard | `frontend2/src/components/Analysis/EdgeDash.jsx` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py stats calc-expectancy` | Run math | `[ ]` |
| `python cli.py stats verify-edge` | Run Monte Carlo | `[ ]` |
