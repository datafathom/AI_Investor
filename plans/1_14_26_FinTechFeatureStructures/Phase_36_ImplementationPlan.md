...
### 36.1 Real-Time Index Holdings Monitor `[ ]`
...
|-----------|-----------|--------|
| Index Monitor | `services/portfolio/index_monitor.py` | `[ ]` |

---

### 36.2 Exposure Warning System (>40%) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Concentration Alert | `services/alerts/concentration.py` | `[ ]` |

---

### 36.3 Beta-Weighted Exposure Calculator `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Beta Calc | `services/analysis/beta_calc.py` | `[ ]` |

---

### 36.4 Dividend Payout Schedule (TimescaleDB) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Schedule Tracker | `services/portfolio/div_schedule.py` | `[ ]` |

---

### 36.5 Neo4j Constituent Mapper `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Constituent Graph | `services/neo4j/constituents.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py index check-beta` | Show total beta | `[ ]` |
| `python cli.py index list-overlap` | Show duplicate exposure | `[ ]` |
