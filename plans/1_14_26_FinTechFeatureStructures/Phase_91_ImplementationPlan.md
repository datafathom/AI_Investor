...
|---------|-------------|--------|
| `python cli.py weather check <region>` | Forecast | `[ ]` |
| `python cli.py weather predict-corn` | Signal | `[ ]` |
