...
| Component | File Path | Status |
|-----------|-----------|--------|
| Grid UI | `frontend2/src/components/Assets/VCGrid.jsx` | `[ ]` |

---

### 79.3 Dilution Simulator (Pro-Rata) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Dilution Sim | `services/simulation/dilution.py` | `[ ]` |

---

### 79.4 QSBS Tax Eligibility Checker `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| QSBS Tracker | `services/tax/qsbs_track.py` | `[ ]` |

### 79.5 Carta/Pulley Integration (Email Parsing) `[ ]`

**Acceptance Criteria**: Ingest update emails from Carta/Pulley to auto-update valuations. (Regex parsing).

| Component | File Path | Status |
|-----------|-----------|--------|
| Parser | `services/ingestion/carta_parse.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py vc add-safe` | New investment | `[ ]` |
| `python cli.py vc check-qsbs` | Eligibility | `[ ]` |
