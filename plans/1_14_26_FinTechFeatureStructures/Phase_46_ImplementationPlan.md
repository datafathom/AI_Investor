...
### 46.1 Real-Time Fred API Yield Plotter `[ ]`

**Acceptance Criteria**: Implement real-time Yield Curve plotting using FRED API data (10Y, 2Y, 3M yields).

| Component | File Path | Status |
|-----------|-----------|--------|
| FRED Service | `services/ingestion/fred_yields.py` | `[ ]` |
| Curve Plotter | `services/analysis/yield_curve.py` | `[ ]` |

---

### 46.2 Recession Signal (10Y-2Y Inversion) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Signal Monitor | `services/alerts/inversion_monitor.py` | `[ ]` |

---

### 46.3 Bond Ladder Interface `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Ladder UI | `frontend2/src/components/Bonds/Ladder.jsx` | `[ ]` |

---

### 46.4 Weighted Average Life (WAL) Calc `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| WAL Calc | `services/analysis/bond_duration.py` | `[ ]` |

### 46.5 Rate Shock Sensitivity Test (+/- 100bps) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Stress Test | `services/simulation/rate_shock.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py bonds show-curve` | Plot yields | `[ ]` |
| `python cli.py bonds check-shock` | Run sensitivity | `[ ]` |
