...
|---------|-------------|--------|
| `python cli.py liquidity net` | Current Net Liq | `[ ]` |
| `python cli.py liquidity global` | Total M2 | `[ ]` |
