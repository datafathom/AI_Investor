...
### 130.1 REIT Liquidity vs. Direct Property Model `[ ]`
...
|-----------|-----------|--------|
| Liquidity Model | `services/real_estate/liquidity_model.py` | `[ ]` |
| Transaction Cost Calc | `services/real_estate/transaction_costs.py` | `[ ]` |
| API Endpoint | `web/api/real_estate/liquidity_compare.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Comparison Calculator | `frontend2/src/components/RealEstate/LiquidityCalculator.jsx` | `[ ]` |
| Cost Breakdown Chart | `frontend2/src/components/Charts/RECostBreakdown.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Liquidity Model | `tests/unit/test_liquidity_model.py` | `[ ]` |
| Integration: Compare API | `tests/integration/test_re_compare_api.py` | `[ ]` |

---

### 130.2 Depreciation Benefit Tracking Service `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Migration | `migrations/130_depreciation.sql` | `[ ]` |
| Depreciation Service | `services/tax/depreciation_service.py` | `[ ]` |
| Tax Shield Calculator | `services/tax/tax_shield_calc.py` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Depreciation Calc | `tests/unit/test_depreciation_calc.py` | `[ ]` |
| Integration: Tax Impact | `tests/integration/test_tax_shield.py` | `[ ]` |

---

### 130.3 Small Institutional Investor Access Logic `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Access Gatekeeper | `services/real_estate/access_gatekeeper.py` | `[ ]` |
| Accreditation Verifier | `services/compliance/accreditation.py` | `[ ]` |

---

### 130.4 Neo4j 1031 Exchange Eligibility Timer `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Exchange Graph Service | `services/neo4j/exchange_1031_graph.py` | `[ ]` |
| Timeline Monitor | `services/real_estate/timeline_monitor.py` | `[ ]` |
| Alert Service | `services/alerts/exchange_deadline.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| 1031 Timeline Tracker | `frontend2/src/components/RealEstate/ExchangeTimeline.jsx` | `[ ]` |
| Deadline Alert | `frontend2/src/components/Alerts/ExchangeDeadline.jsx` | `[ ]` |

---

### 130.5 Time-to-Exit Comparison Calculator `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Time-to-Exit Calc | `services/real_estate/time_to_exit.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py re compare` | Run REIT vs Direct comparison | `[ ]` |
| `python cli.py re depreciation <cost>` | Calculate depreciation schedule | `[ ]` |
| `python cli.py re 1031-deadline <date>` | Calculate 1031 deadlines | `[ ]` |
