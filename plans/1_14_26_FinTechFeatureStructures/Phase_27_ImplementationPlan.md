...
### 27.1 Cron Health Check Microservice `[ ]`
...
|-----------|-----------|--------|
| Scheduler | `services/warden/scheduler.py` | `[ ]` |
| Routine Runner | `services/warden/routine_runner.py` | `[ ]` |

---

### 27.2 Liquidity Depth Checker `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Depth Checker | `services/market/depth_check.py` | `[ ]` |

---

### 27.3 Volatility Boundary Monitor (VIX/ATR) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Vol Monitor | `services/market/vol_boundary.py` | `[ ]` |

---

### 27.4 'Defensive Capital Shielding' Flag `[ ]`

**Acceptance Criteria**: A global system state stored in Redis. `SHIELD_MODE = TRUE`. Agents check this before trading.

| Component | File Path | Status |
|-----------|-----------|--------|
| Shield Logic | `services/modes/shield_logic.py` | `[ ]` |

---

### 27.5 UnifiedActivityService Health Log `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Logger | `services/logging/health_log.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py warden run-check` | Manual triggering | `[ ]` |
| `python cli.py warden status` | Show latest health | `[ ]` |
