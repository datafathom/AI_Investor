...
|---------|-------------|--------|
| `python cli.py clone build <manager>` | Create portfolio | `[ ]` |
| `python cli.py clone backtest` | Verify performance | `[ ]` |
