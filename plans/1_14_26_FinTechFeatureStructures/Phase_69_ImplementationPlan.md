...
|---------|-------------|--------|
| `python cli.py vol show-skew` | Put/Call ratio | `[ ]` |
| `python cli.py vol check-term` | Struct state | `[ ]` |
