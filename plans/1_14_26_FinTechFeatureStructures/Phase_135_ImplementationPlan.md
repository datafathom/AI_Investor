...
### 135.1 Glide-Path Equity → Bond Shift Service `[ ]`
...
|-----------|-----------|--------|
| Glide Path Engine | `services/retirement/glide_path_engine.py` | `[ ]` |
| Shift Executor | `services/trading/shift_executor.py` | `[ ]` |
| API Endpoint | `web/api/retirement/glide_path.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Glide Path Visualizer | `frontend2/src/components/Charts/GlidePathVisualizer.jsx` | `[ ]` |
| Allocation Shift Preview | `frontend2/src/components/Portfolio/ShiftPreview.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Glide Path Engine | `tests/unit/test_glide_path_engine.py` | `[ ]` |
| Integration: Shift Execution | `tests/integration/test_shift_execution.py` | `[ ]` |

---

### 135.2 Postgres Target Year Milestone Schema `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Migration | `migrations/135_goal_milestones.sql` | `[ ]` |
| Goal Model | `models/goal_milestone.py` | `[ ]` |

---

### 135.3 Neo4j 529 Plan Allocation Relationships `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Goal Graph Service | `services/neo4j/goal_graph.py` | `[ ]` |

---

### 135.4 Kafka 12-Month Risk Reduction Trigger `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Deadline Monitor | `services/kafka/deadline_monitor.py` | `[ ]` |
| Risk Reducer | `services/risk/risk_reducer.py` | `[ ]` |

---

### 135.5 State-Specific 529 Glide-Path Validator `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| State Validator | `services/compliance/state_529_validator.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py glide-path target <years>` | Calculate target alloc | `[ ]` |
| `python cli.py glide-path shift` | Execute allocation shifts | `[ ]` |
