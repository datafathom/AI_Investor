...
### 80.1 Dark Pool Tape Ingestion `[ ]`

**Acceptance Criteria**: Ingest tape. Filter for Exchange Code "D" (ADF) or similar off-exchange identifiers.

| Component | File Path | Status |
|-----------|-----------|--------|
| Tape Reader | `services/ingestion/dark_tape.py` | `[ ]` |

---

### 80.2 Block Trade Cluster Detection `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Cluster Algo | `services/analysis/block_cluster.py` | `[ ]` |

---

### 80.3 Support/Resistance from Dark Levels `[ ]`

**Acceptance Criteria**: Identify price levels with massive dark volume. These act as "Magnetic" support/resistance.

| Component | File Path | Status |
|-----------|-----------|--------|
| Level Finder | `services/analysis/dark_levels.py` | `[ ]` |

---

### 80.4 Neo4j Dark Pool Activity Nodes `[ ]`

**Acceptance Criteria**: Map `(:ASSET)-[:HAS_DARK_ACTIVITY]->(:LEVEL {price: 150.00, vol: 5M})`.

| Component | File Path | Status |
|-----------|-----------|--------|
| Graph Mapper | `services/neo4j/dark_graph.py` | `[ ]` |

### 80.5 'Signature' Prints Alert `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Sig Alert | `services/alerts/signature_print.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py dark stream` | Watch tape | `[ ]` |
| `python cli.py dark significant` | Show huge blocks | `[ ]` |
