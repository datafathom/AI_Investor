...
### 136.1 Postgres Margin Balance/Interest Tracking `[ ]`
...
|-----------|-----------|--------|
| Migration | `migrations/136_margin_history.sql` | `[ ]` |
| Margin Tracker | `services/risk/margin_tracker.py` | `[ ]` |
| Interest Calculator | `services/finance/interest_calculator.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Margin Dashboard | `frontend2/src/components/Risk/MarginDashboard.jsx` | `[ ]` |
| Interest Cost Chart | `frontend2/src/components/Charts/MarginInterest.jsx` | `[ ]` |

---

### 136.2 Equity vs. Borrowed Funds Kafka Monitor `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Leverage Monitor | `services/kafka/leverage_monitor.py` | `[ ]` |
| Alert Service | `services/alerts/leverage_alerts.py` | `[ ]` |

---

### 136.3 Futures/Options Indirect Leverage Logic `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Indirect Calc | `services/risk/indirect_leverage.py` | `[ ]` |
| Notional Service | `services/market/notional_value.py` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Indirect Calc | `tests/unit/test_indirect_leverage.py` | `[ ]` |
| Unit: Notional Service | `tests/unit/test_notional_value.py` | `[ ]` |

---

### 136.4 Double-Edged Sword Simulator (±40%) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Leverage Simulator | `services/simulation/leverage_sim.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Leverage Simulator UI | `frontend2/src/components/Simulator/LeverageSim.jsx` | `[ ]` |

---

### 136.5 Margin Call Alert Trigger `[ ]`

**Acceptance Criteria**: Predictive alert that triggers *before* a margin call happens (e.g., when buffer drops below 10%).

| Component | File Path | Status |
|-----------|-----------|--------|
| Pre-Call Trigger | `services/risk/pre_call_trigger.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py risk leverage` | Show true leverage | `[ ]` |
| `python cli.py risk margin` | Show margin utilization | `[ ]` |
