...
### 122.1 Sharpe Ratio Calculator Microservice `[x]`
...
|-----------|-----------|--------|
| Sharpe Calculator | `services/quantitative/sharpe_calculator.py` | `[x]` |
| Returns Processor | `services/quantitative/returns_processor.py` | `[x]` |
| API Endpoint | `web/api/metrics/sharpe.py` | `[x]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Sharpe Calculator | `tests/unit/test_sharpe_calculator.py` | `[x]` |
| Integration: API | `tests/integration/test_sharpe_api.py` | `[x]` |

---

### 122.2 Risk-Free Rate Data Storage `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Migration | `migrations/122_risk_free_rates.sql` | `[x]` |
| FRED API Client | `services/external/fred_client.py` | `[x]` |
| Rate Ingestion | `services/rate_ingestion_service.py` | `[x]` |

---

### 122.3 Portfolio Volatility Analyzer `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Volatility Analyzer | `services/quantitative/volatility_analyzer.py` | `[x]` |
| Statistics Utils | `utils/statistics.py` | `[x]` |

---

### 122.4 Sharpe Ratio Grading System `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Sharpe Grader | `services/quantitative/sharpe_grader.py` | `[x]` |
| Grade Config | `config/sharpe_grades.py` | `[x]` |

---

### 122.5 Upside Volatility Warning System `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Upside Detector | `services/quantitative/upside_volatility_detector.py` | `[x]` |
| Warning Service | `services/alerts/sharpe_warning_service.py` | `[x]` |
...
|-------------|--------|--------------|
| 122.1 Sharpe Calculator | `[x]` | `[ ]` |
| 122.2 Risk-Free Rate Storage | `[x]` | `[ ]` |
| 122.3 Volatility Analyzer | `[x]` | `[ ]` |
| 122.4 Grading System | `[x]` | `[ ]` |
| 122.5 Upside Warning | `[x]` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py sharpe <portfolio_id>` | Calculate Sharpe ratio | `[x]` |
| `python cli.py rfr-update` | Update risk-free rates | `[x]` |
| `python cli.py volatility <portfolio_id>` | Analyze volatility | `[x]` |
