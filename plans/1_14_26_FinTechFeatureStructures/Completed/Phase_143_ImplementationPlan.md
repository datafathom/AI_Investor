...
### 143.1 Real-time Loser Position Trigger `[x]`
...
|-----------|-----------|--------|
| Migration | `migrations/143_tax_lots.sql` | `[x]` |
| Lot Monitor | `services/tax/lot_monitor.py` | `[x]` |
| Opportunity Generator | `services/tax/opportunity_gen.py` | `[x]` |

---

### 143.2 Capital Loss ↔ Gain Matching (15% bracket) `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Gain/Loss Matcher | `services/tax/gain_loss_matcher.py` | `[x]` |
| Tax liability Calc | `services/tax/liability_calc.py` | `[x]` |

---

### 143.3 Kafka Liquidity Needs Prioritization `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Liquidity Consumer | `services/kafka/liquidity_consumer.py` | `[x]` |
| Withdrawal Optimizer | `services/tax/withdrawal_optimizer.py` | `[x]` |

---

### 143.4 30-Day Wash Sale Validator `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Wash Sale Validator | `services/compliance/wash_sale_validator.py` | `[x]` |
| Identical Security Map | `config/substantially_identical.json` | `[x]` |

---

### 143.5 Net Tax Liability Calculator `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Total Liability Calc | `services/tax/total_liability.py` | `[x]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Harvesting Dashboard | `frontend2/src/components/Tax/HarvestingDashboard.jsx` | `[x]` |
| Tax Savings Widget | `frontend2/src/components/Tax/TaxSavings.jsx` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py tax scan-losses` | Scan for harvesting opps | `[x]` |
| `python cli.py tax wash-check <ticker>` | Check wash sale status | `[x]` |
