...
### 95.1 Baltic Dry Index Monitor `[x]`

**Acceptance Criteria**: Leading indicator for raw material demand.

| Component | File Path | Status |
|-----------|-----------|--------|
| BDI Mon | `services/market/baltic_dry.py` | `[x]` |

---

### 95.2 Container Freight Rates (Shanghai-LA) `[x]`

**Acceptance Criteria**: Track costs. High cost = Inflation. Low cost = Low Demand.

| Component | File Path | Status |
|-----------|-----------|--------|
| Freight Rates | `services/analysis/freight_cost.py` | `[x]` |

---

### 95.3 Trucking Tonnage Index `[x]`

**Acceptance Criteria**: ATA Tonnage Index. Domestic US health.

| Component | File Path | Status |
|-----------|-----------|--------|
| Trucking | `services/market/trucking_index.py` | `[x]` |

---

### 95.4 Port Congestion Satellite Data `[x]`

**Acceptance Criteria**: Count ships waiting at anchor (Long Beach/Rotterdam). Supply chain bottleneck indicator.

| Component | File Path | Status |
|-----------|-----------|--------|
| Port Sat | `services/ingestion/port_congestion.py` | `[x]` |

### 95.5 FedEx/UPS Volume Proxy `[x]`

**Acceptance Criteria**: Track volume guidance from major carriers.

| Component | File Path | Status |
|-----------|-----------|--------|
| Parcel Vol | `services/analysis/parcel_vol.py` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py ship prices` | Container rates | `[x]` |
| `python cli.py ship congestion` | Ship queue count | `[x]` |
