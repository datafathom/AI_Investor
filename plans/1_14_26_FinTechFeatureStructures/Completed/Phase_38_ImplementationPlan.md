...
### 38.1 Traditional vs. Roth Simulator `[x]`
...
|-----------|-----------|--------|
| Tax Sim | `services/planning/tax_sim.py` | `[x]` |

---

### 38.2 IRS Contribution Limiter (2024/2025) `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Limit Checker | `services/compliance/irs_limits.py` | `[x]` |

---

### 38.3 Employer Match Tracker `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Match Tracker | `services/planning/match_tracker.py` | `[x]` |

---

### 38.4 Backdoor Roth Feasibility Checker `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Backdoor Logic | `services/planning/backdoor_roth.py` | `[x]` |

---

### 38.5 Postgres Entity Management Schema `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Migration | `migrations/38_tax_wrappers.sql` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py tax check-limit` | Show remaining contrib | `[x]` |
| `python cli.py tax sim-roth` | Run comparison | `[x]` |
