...
### 118.1 Pension Sustainability Simulation `[x]`
| Component | File Path | Status |
|-----------|-----------|--------|
| Pension Simulator | `services/retirement/pension_simulator.py` | `[x]` |
| Funding Ratio Analyzer | `services/retirement/funding_ratio.py` | `[x]` |

### 118.2 Legacy Pension Payment Schedule Table `[x]`
```sql
...
### 118.3 Employer to Matching Migration Tool `[x]`
| Component | File Path | Status |
|-----------|-----------|--------|
| Migration Calculator | `services/retirement/db_to_dc_migration.py` | `[x]` |

### 118.4 Pension Failure Historical Database `[x]`
Track historical pension failures for risk modeling.

### 118.5 Grandfathered Pension Fixed-Income Logic `[x]`
