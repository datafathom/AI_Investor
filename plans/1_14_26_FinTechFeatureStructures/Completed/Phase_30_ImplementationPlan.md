...
### 30.1 Real-Time 'Distance to Liquidation' Calc `[x]`
...
|-----------|-----------|--------|
| Margin Calc | `services/risk/margin_calc.py` | `[x]` |

---

### 30.2 'Red Pulse' Danger Zone Alert `[x]`

**Acceptance Criteria**: Trigger a 'Red Pulse' visual alert in the Warden console when the total margin buffer drops below 15.0%.

| Component | File Path | Status |
|-----------|-----------|--------|
| Alert Service | `services/alerts/margin_alert.py` | `[x]` |
| Frontend Pulse | `frontend2/src/components/Warden/RedPulse.jsx` | `[x]` |

---

### 30.3 Prioritized De-leveraging Sequence `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Sequencer | `services/risk/deleverage.py` | `[x]` |

---

### 30.4 Margin Check Audit Log `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Audit Log | `services/logging/margin_audit.py` | `[x]` |

---

### 30.5 Margin Stress Simulator `[x]`

**Acceptance Criteria**: Tool to simulate: "If SPY drops 5%, what happens to my margin?".

| Component | File Path | Status |
|-----------|-----------|--------|
| Simulator | `services/simulation/margin_stress.py` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py margin check` | Current margin % | `[x]` |
| `python cli.py margin simulate <drop_pct>` | Stress test | `[x]` |
