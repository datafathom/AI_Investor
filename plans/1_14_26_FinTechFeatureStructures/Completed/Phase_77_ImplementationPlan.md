...
|---------|-------------|--------|
| `python cli.py regime status` | Infl/Defl | `[x]` |
| `python cli.py regime compare-fractal` | 1970s correlation | `[x]` |
