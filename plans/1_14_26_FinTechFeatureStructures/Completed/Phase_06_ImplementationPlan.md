...
|-----------|-----------|--------|
| Demo Broker Client | `services/brokers/demo_broker.py` | `[x]` |
| Trade Executor (Demo) | `services/trade_executor_demo.py` | `[x]` |
| API Adapter | `services/brokers/adapters/ic_markets.py` | `[x]` |

#### API Configuration

| Setting | Value | Status |
|---------|-------|--------|
| Demo API URL | `https://demo-api.icmarkets.com` | `[x]` |
| Auth Method | API Key + Secret | `[x]` |
| Rate Limit | 100 req/min | `[x]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Demo Broker | `tests/unit/test_demo_broker.py` | `[x]` |
| Integration: Trade Flow | `tests/integration/test_demo_trade.py` | `[x]` |

---

### 6.2 is_demo Flag Implementation `[x]`
...
| Demo Mode Context | `frontend2/src/context/DemoModeContext.jsx` | `[x]` |
| Demo Indicator | `frontend2/src/components/DemoIndicator.jsx` | `[x]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Market Tuition Logger | `services/market_tuition_logger.py` | `[x]` |
| Loss Categorizer | `services/loss_categorizer.py` | `[x]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Demo Reset Service | `services/demo_reset_service.py` | `[x]` |
| Reset API Endpoint | `web/api/demo/reset.py` | `[x]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Reset Button | `frontend2/src/components/DemoResetButton.jsx` | `[x]` |
| Confirmation Modal | `frontend2/src/components/modals/ResetConfirmModal.jsx` | `[x]` |

---

### 6.5 Agent Persona Metadata `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Agent Metadata Injector | `services/agent_metadata_injector.py` | `[x]` |
| Transaction Logger | `services/transaction_logger.py` | `[x]` |
...
|-------------|--------|--------------|
| 6.1 Demo Broker API | `[x]` | `[✓]` |
| 6.2 is_demo Flag | `[x]` | `[✓]` |
| 6.3 Market Tuition | `[x]` | `[✓]` |
| 6.4 System Reset | `[x]` | `[✓]` |
| 6.5 Agent Metadata | `[x]` | `[✓]` |
