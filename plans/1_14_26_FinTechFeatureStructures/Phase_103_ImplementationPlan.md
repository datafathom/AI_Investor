...
### 103.1 Kafka Liquid Cash vs. Expenses Stream `[ ]`
...
|-----------|-----------|--------|
| Migration | `migrations/103_emergency_fund.sql` | `[ ]` |
| Model | `models/emergency_fund.py` | `[ ]` |
| Kafka Producer | `services/kafka/emergency_fund_producer.py` | `[ ]` |
| Expense Calculator | `services/planning/expense_calculator.py` | `[ ]` |
| Coverage Analyzer | `services/planning/coverage_analyzer.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Emergency Fund Widget | `frontend2/src/components/EmergencyFund/FundWidget.jsx` | `[ ]` |
| Coverage Gauge | `frontend2/src/components/EmergencyFund/CoverageGauge.jsx` | `[ ]` |
| Expense Breakdown | `frontend2/src/components/EmergencyFund/ExpenseBreakdown.jsx` | `[ ]` |
| useEmergencyFund Hook | `frontend2/src/hooks/useEmergencyFund.js` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Model | `tests/unit/test_emergency_fund_model.py` | `[ ]` |
| Unit: Calculator | `tests/unit/test_expense_calculator.py` | `[ ]` |
| Unit: Analyzer | `tests/unit/test_coverage_analyzer.py` | `[ ]` |
| Integration: Kafka | `tests/integration/test_emergency_fund_kafka.py` | `[ ]` |
| E2E: Widget UI | `tests/e2e/test_emergency_fund_widget.py` | `[ ]` |

---

### 103.2 Threshold Alert System (3 months to 3 years) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Alert Service | `services/alerts/emergency_fund_alerts.py` | `[ ]` |
| Notification Router | `services/notifications/alert_router.py` | `[ ]` |
| Trade Blocker | `services/trading/coverage_blocker.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Alert Banner | `frontend2/src/components/Alerts/EmergencyFundAlert.jsx` | `[ ]` |
| Tier Indicator | `frontend2/src/components/EmergencyFund/TierIndicator.jsx` | `[ ]` |
| Action Suggestions | `frontend2/src/components/EmergencyFund/ActionSuggestions.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Alert Service | `tests/unit/test_emergency_fund_alerts.py` | `[ ]` |
| Unit: Tier Calculation | `tests/unit/test_tier_calculation.py` | `[ ]` |
| Integration: Notifications | `tests/integration/test_alert_notifications.py` | `[ ]` |

---

### 103.3 Portfolio Liquidation Constraint Trigger `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Liquidation Constraint | `services/risk/liquidation_constraint.py` | `[ ]` |
| Investment Blocker | `services/trading/investment_blocker.py` | `[ ]` |
| Override Handler | `services/compliance/override_handler.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Block Modal | `frontend2/src/components/Modals/LiquidationConstraintModal.jsx` | `[ ]` |
| Fund Priority Guide | `frontend2/src/components/Guides/FundPriorityGuide.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Constraint | `tests/unit/test_liquidation_constraint.py` | `[ ]` |
| Integration: Block Flow | `tests/integration/test_investment_block.py` | `[ ]` |
| E2E: Block Modal | `tests/e2e/test_block_modal_ui.py` | `[ ]` |

---

### 103.4 Dynamic Career Risk Adjustment `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Career Risk Scorer | `services/planning/career_risk_scorer.py` | `[ ]` |
| Industry Data Service | `services/external/industry_data.py` | `[ ]` |
| Fund Size Adjuster | `services/planning/fund_size_adjuster.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Career Risk Form | `frontend2/src/components/Forms/CareerRiskForm.jsx` | `[ ]` |
| Risk Breakdown Chart | `frontend2/src/components/Charts/CareerRiskChart.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Risk Scorer | `tests/unit/test_career_risk_scorer.py` | `[ ]` |
| Unit: Size Adjuster | `tests/unit/test_fund_size_adjuster.py` | `[ ]` |
| Integration: Full Pipeline | `tests/integration/test_career_risk_pipeline.py` | `[ ]` |

---

### 103.5 Medical Catastrophe Simulation Engine `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Simulator | `services/planning/medical_catastrophe_sim.py` | `[ ]` |
| Scenario Library | `config/medical_scenarios.py` | `[ ]` |
| Impact Calculator | `services/planning/impact_calculator.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Simulator Interface | `frontend2/src/components/Simulator/MedicalCatastropheSim.jsx` | `[ ]` |
| Scenario Selector | `frontend2/src/components/Simulator/ScenarioSelector.jsx` | `[ ]` |
| Impact Visualization | `frontend2/src/components/Charts/ImpactVisualization.jsx` | `[ ]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Simulator | `tests/unit/test_medical_catastrophe_sim.py` | `[ ]` |
| Unit: Impact Calculator | `tests/unit/test_impact_calculator.py` | `[ ]` |
| Integration: Full Simulation | `tests/integration/test_catastrophe_simulation.py` | `[ ]` |
...
|-------------|--------|--------------|
| 103.1 Kafka Expense Stream | `[ ]` | `[ ]` |
| 103.2 Threshold Alerts | `[ ]` | `[ ]` |
| 103.3 Liquidation Constraint | `[ ]` | `[ ]` |
| 103.4 Career Risk Adjustment | `[ ]` | `[ ]` |
| 103.5 Medical Catastrophe Sim | `[ ]` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py emergency-fund status` | Check fund status | `[ ]` |
| `python cli.py emergency-fund simulate <scenario>` | Run simulation | `[ ]` |
| `python cli.py emergency-fund career-risk` | Assess career risk | `[ ]` |
