...
### 70.1 Volatility-Weighted Allocation Logic `[ ]`
...
|-----------|-----------|--------|
| Parity Calc | `services/strategies/risk_parity.py` | `[ ]` |

---

### 70.2 Correlation Adjustment `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Corr Adjust | `services/analysis/parity_corr.py` | `[ ]` |

---

### 70.3 Regime-Based Portfolio Switching `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Switcher | `services/strategies/regime_switch.py` | `[ ]` |

---

### 70.4 Levered Bond Implementation (UPRO/TMF) `[ ]`

**Acceptance Criteria**: Support Leveraged ETFs (UPRO, TMF) to achieve risk parity with smaller capital. Warning: Decay Risk.

| Component | File Path | Status |
|-----------|-----------|--------|
| Lev Manager | `services/risk/leveraged_etf.py` | `[ ]` |

### 70.5 Backtest: All Weather vs 60/40 `[ ]`

**Acceptance Criteria**: Continuous backtest showing how All Weather performs in 2008 and 2022 vs standard 60/40.

| Component | File Path | Status |
|-----------|-----------|--------|
| Comparator | `frontend2/src/components/Analysis/StratCompare.jsx` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py parity calc` | Get target weights | `[ ]` |
| `python cli.py parity backtest` | Run comparison | `[ ]` |
