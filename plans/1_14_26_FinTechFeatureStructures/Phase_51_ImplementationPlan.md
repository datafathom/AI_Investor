...
### 51.1 Hardware Wallet Connect Dashboard `[ ]`
...
|-----------|-----------|--------|
| Wallet Connect | `frontend2/src/components/Crypto/WalletConnect.jsx` | `[ ]` |
| Balance Fetcher | `services/crypto/balance_fetcher.py` | `[ ]` |

---

### 51.2 On-chain LP Tracker (Impermanent Loss) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| LP Tracker | `services/crypto/lp_tracker.py` | `[ ]` |

---

### 51.3 Gas Fee Optimization Widget ('Gwei Pulse') `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Gas Widget | `frontend2/src/components/Crypto/GasPulse.jsx` | `[ ]` |

---

### 51.4 Neo4j LP Node Mapping `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Graph Service | `services/neo4j/crypto_graph.py` | `[ ]` |

---

### 51.5 Real-Time USD Valuation (Kafka) `[ ]`

**Acceptance Criteria**: Verify real-time USD valuation of crypto assets using Kafka-driven price feeds (CoinGecko/Binance).

| Component | File Path | Status |
|-----------|-----------|--------|
| Valuation Svc | `services/crypto/valuation.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py crypto scan-wallet <addr>` | Index balances | `[ ]` |
| `python cli.py crypto check-gas` | Current Gwei | `[ ]` |
