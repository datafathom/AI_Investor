...
### 63.1 House/Senate Disclosure Scraper `[ ]`
...
|-----------|-----------|--------|
| Scraper | `services/ingestion/congress_scraper.py` | `[ ]` |

---

### 63.2 `POLITICAL_INSIDER` Neo4j Nodes `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Graph Mapper | `services/neo4j/politics_graph.py` | `[ ]` |

---

### 63.3 Anomaly Detection (Timing vs Legislation) `[ ]`

**Acceptance Criteria**: Detect trades timed < 30 days before major legislative votes. Flag as "High Suspicion".

| Component | File Path | Status |
|-----------|-----------|--------|
| Anomaly Detector | `services/analysis/political_alpha.py` | `[ ]` |

---

### 63.4 The 'Nancy Pelosi' Copy-Trade Strategy `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Copy Trader | `services/strategies/pelosi_copy.py` | `[ ]` |

### 63.5 Disclosure Lag Analysis `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Lag Analyzer | `services/analysis/reporting_lag.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py politics scrape` | Run scraper | `[ ]` |
| `python cli.py politics show-trades` | Recent filings | `[ ]` |
