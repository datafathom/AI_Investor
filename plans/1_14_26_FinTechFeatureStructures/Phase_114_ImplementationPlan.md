...
> **Status**: `[ ]` Not Started | **Owner**: Billing Team
...
### 114.1 Postgres Monthly/Quarterly Proration Service `[ ]`
...
|-----------|-----------|--------|
| Migration | `migrations/114_fee_billing.sql` | `[ ]` |
| Fee Calculator | `services/billing/fee_calculator.py` | `[ ]` |
| Proration Service | `services/billing/proration_service.py` | `[ ]` |

### 114.2 Declining Fee Balance Logic (1% → 0.6%) `[ ]`
| Component | File Path | Status |
|-----------|-----------|--------|
| Tiered Fee Calculator | `services/billing/tiered_fee_calc.py` | `[ ]` |

### 114.3 Performance-Based Hurdle Rate Calculator `[ ]`
| Component | File Path | Status |
|-----------|-----------|--------|
| Hurdle Calculator | `services/billing/hurdle_calculator.py` | `[ ]` |
| Performance Fee Service | `services/billing/performance_fee.py` | `[ ]` |

### 114.4 High Water Mark Validator `[ ]`
Ensure performance fees only charged above previous high water mark.

| Component | File Path | Status |
|-----------|-----------|--------|
| HWM Tracker | `services/billing/high_water_mark.py` | `[ ]` |

### 114.5 Neo4j Load/Wrap Fee Legacy Mapping `[ ]`
