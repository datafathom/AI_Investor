...
### 144.1 Fixed Monthly Allowance Constraint `[ ]`
...
|-----------|-----------|--------|
| Allowance Engine | `services/estate/allowance_engine.py` | `[ ]` |
| Distribution Gate | `services/payment/distribution_gate.py` | `[ ]` |

---

### 144.2 Trust Asset Leverage Block `[ ]`

**Acceptance Criteria**: Prevent trust assets from being used as collateral for beneficiary loans (e.g., Margin loans, mortgages).

| Component | File Path | Status |
|-----------|-----------|--------|
| Leverage Blocker | `services/compliance/leverage_blocker.py` | `[ ]` |
| Pledging Monitor | `services/custody/pledging_monitor.py` | `[ ]` |

---

### 144.3 Postgres Creditor Shield `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Creditor Shield | `services/legal/creditor_shield.py` | `[ ]` |
| Garnishment Rejector | `services/legal/garnishment_handler.py` | `[ ]` |

---

### 144.4 Real Estate Mortgage Block `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Lien Prevention | `services/real_estate/lien_prevention.py` | `[ ]` |

---

### 144.5 Neo4j Irresponsible Heir Risk Mapping `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Risk Mapper | `services/neo4j/heir_risk_mapper.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Spending Controls UI | `frontend2/src/components/Estate/SpendingControls.jsx` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py spendthrift checks` | Run spending checks | `[ ]` |
| `python cli.py spendthrift block-loan` | Execute leverage block | `[ ]` |
