...
| Component | File Path | Status |
|-----------|-----------|--------|
| Alpha Calc | `services/analysis/harvest_alpha.py` | `[ ]` |

---

### 45.3 Wash-Sale Protection (30-Day Rule) `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Wash Guard | `services/compliance/wash_sale.py` | `[ ]` |

---

### 45.4 Fiscal Quarter Reporting `[ ]`

**Acceptance Criteria**: Log the total 'Tax Shield' dollar value generated by the system per fiscal quarter.

| Component | File Path | Status |
|-----------|-----------|--------|
| Report Gen | `services/reporting/tax_shield_report.py` | `[ ]` |

### 45.5 Manual Review Toggle `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Review Toggle | `services/settings/harvest_settings.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py harvest scan` | Find opps | `[ ]` |
| `python cli.py harvest check-wash <ticker>` | Safe to buy? | `[ ]` |
