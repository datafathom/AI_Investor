...
### 133.1 Rolling 1-Year/3-Year Std Dev Function `[ ]`
...
|-----------|-----------|--------|
| Rolling Volatility | `services/quantitative/rolling_volatility.py` | `[ ]` |
| Window Manager | `services/data/window_manager.py` | `[ ]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Rolling Vol Chart | `frontend2/src/components/Charts/RollingVolatility.jsx` | `[ ]` |

### 133.2 Daily Price Return Kafka Producer `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Returns Producer | `services/kafka/returns_producer.py` | `[ ]` |
| Price Ingester | `services/market/price_ingester.py` | `[ ]` |

### 133.3 High Volatility Outlier Filter `[ ]`

**Acceptance Criteria**: Filter extreme outlier events (3+ sigma moves) to analyze tail risk separately from normal volatility.

| Component | File Path | Status |
|-----------|-----------|--------|
| Outlier Detector | `services/quantitative/outlier_detector.py` | `[ ]` |
| Tail Risk Analyzer | `services/risk/tail_risk_analyzer.py` | `[ ]` |

### 133.4 Neo4j Volatility Event → Asset Relationships `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Event Mapper | `services/neo4j/volatility_event_mapper.py` | `[ ]` |

### 133.5 SMA Securities Std Dev Verification `[ ]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| SMA Verifier | `services/compliance/sma_risk_verifier.py` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py vol rolling <ticker>` | Show rolling volatility | `[ ]` |
| `python cli.py vol outliers <ticker>` | List outlier events | `[ ]` |
