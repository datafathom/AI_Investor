...
### 78.1 SBLOC Feasibility Calculator `[ ]`
...
|-----------|-----------|--------|
| Calc Tool | `services/analysis/sbloc_calc.py` | `[ ]` |

---

### 78.2 Debt Payoff Optimizer (Avalanche/Snowball) `[ ]`
...
|---------|-------------|--------|
| `python cli.py liability compare <amount>` | Borrow vs Sell | `[ ]` |
| `python cli.py liability list` | Show all debts | `[ ]` |
