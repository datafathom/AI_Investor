...
> **Status**: `[x]` Completed | **Owner**: International Team
...
### 116.1 State-Owned Enterprise Postgres Flag `[x]`
...
|-----------|-----------|--------|
| SOE Classifier | `services/international/soe_classifier.py` | `[x]` |
| Country Risk Service | `services/risk/country_risk.py` | `[x]` |

### 116.2 Single-Company Concentration Analyzer `[x]`
Flag indices with excessive single-company weighting (e.g., TSMC in Taiwan).

| Component | File Path | Status |
|-----------|-----------|--------|
| Concentration Analyzer | `services/international/concentration_analyzer.py` | `[x]` |

### 116.3 Neo4j Foreign Capital Tradability Graph `[x]`
...
### 116.4 Kafka Geopolitical Methodology Stream `[x]`
Stream geopolitical risk updates affecting index methodology changes.

### 116.5 Inefficient Index Government Interest Filter `[x]`
