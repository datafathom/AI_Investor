...
### 42.1 30-Year Compounding Simulator `[x]`
...
|-----------|-----------|--------|
| Simulator | `services/simulation/compound_wealth.py` | `[x]` |

---

### 42.2 Tax Bracket Optimizer (Break-Even) `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Bracket Opt | `services/planning/bracket_opt.py` | `[x]` |

---

### 42.3 D3.js Spendable Income Chart `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Chart | `frontend2/src/components/Charts/TaxComp.jsx` | `[x]` |

---

### 42.4 RMD (Required Minimum Distribution) Logic `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| RMD Calc | `services/planning/rmd_calc.py` | `[x]` |

### 42.5 TimescaleDB Analysis Vault `[x]`

**Acceptance Criteria**: Store all tax simulation parameters and results in TimescaleDB for historical comparison.

| Component | File Path | Status |
|-----------|-----------|--------|
| Vault Saver | `services/storage/sim_saver.py` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py tax forecast` | Run 30yr sim | `[x]` |
| `python cli.py tax check-rmd <age>` | Calc required | `[x]` |
