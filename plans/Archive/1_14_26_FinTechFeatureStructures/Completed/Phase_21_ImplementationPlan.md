...
|-----------|-----------|--------|
| Migration | `migrations/21_circuit_breaker.sql` | `[x]` |
| Drawdown Aggregator | `services/risk/drawdown_aggregator.py` | `[x]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Middleware | `api/middleware/circuit_breaker.py` | `[x]` |
| Zen Mode Activator | `services/modes/zen_mode.py` | `[x]` |
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Redis Lock | `services/infrastructure/redis_lock.py` | `[x]` |

---

### 21.4 Warden Override (MFA Required) `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| MFA Service | `services/auth/mfa_service.py` | `[x]` |
| Override Handler | `services/risk/override_handler.py` | `[x]` |

---

### 21.5 Kafka Freeze Broadcast `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Freeze Publisher | `services/kafka/freeze_publisher.py` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py risk check-drawdown` | Show current % | `[x]` |
| `python cli.py risk simulate-breach` | Test circuit breaker | `[x]` |
