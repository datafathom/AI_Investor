...
### 65.1 SEC Form 4 Real-Time Feed `[x]`
...
|-----------|-----------|--------|
| Edgar Poller | `services/ingestion/form4_poller.py` | `[x]` |

---

### 65.2 'Cluster Buy' Detection `[x]`
...
|---------|-------------|--------|
| `python cli.py insider monitor` | Start polling | `[x]` |
| `python cli.py insider stats <ticker>` | Show CEO track record | `[x]` |
