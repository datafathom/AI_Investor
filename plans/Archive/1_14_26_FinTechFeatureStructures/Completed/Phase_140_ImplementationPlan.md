...
### 140.1 Phase 21-39 Metrics → Wealth Manager Link `[x]`
...
|-----------|-----------|--------|
| Metrics Aggregator | `services/reporting/metrics_aggregator.py` | `[x]` |
| Wealth Manager API | `web/api/dashboard/wealth_manager.py` | `[x]` |

#### Frontend Implementation

| Component | File Path | Status |
|-----------|-----------|--------|
| Client Overview | `frontend2/src/components/Dashboard/ClientOverview.jsx` | `[x]` |
| Key Metrics Card | `frontend2/src/components/Dashboard/KeyMetrics.jsx` | `[x]` |

---

### 140.2 REIT/Diversification → Estate Planning Access `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Asset Bridge | `services/estate/asset_bridge.py` | `[x]` |

---

### 140.3 Portfolio Risk Summary Export `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Report Generator | `services/reporting/risk_summary_pdf.py` | `[x]` |
| PDF Template | `templates/reports/risk_summary.html` | `[x]` |

---

### 140.4 Kafka Bridge to Phase 141 Tax Loss Harvesting `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Loss Monitor Producer | `services/kafka/loss_monitor_producer.py` | `[x]` |

---

### 140.5 Neo4j Core Portfolio Root for Trusts `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Trust Root Service | `services/neo4j/trust_root_service.py` | `[x]` |
...
|---------|-------------|--------|
| `python cli.py bridge status` | Check epoch transition status | `[x]` |
| `python cli.py report generate-risk <id>` | Generate risk PDF | `[x]` |
