...
### 101.1 Advisor Postgres Table with Fiduciary Status `[x]`
...
|-----------|-----------|--------|
| Migration | `migrations/101_advisors.sql` | `[x]` |
| Model | `models/advisor.py` | `[x]` |
| Service | `services/advisor_service.py` | `[x]` |

#### Tests

| Test Type | File Path | Status |
|-----------|-----------|--------|
| Unit: Advisor Model | `tests/unit/test_advisor_model.py` | `[x]` |
| Integration: Advisor CRUD | `tests/integration/test_advisor_crud.py` | `[x]` |

---

### 101.2 Conflict of Interest Score (COIS) `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| COIS Calculator | `services/compliance/cois_calculator.py` | `[x]` |
| Commission Detector | `services/compliance/commission_detector.py` | `[x]` |
| Kafka Consumer | `services/kafka/cois_consumer.py` | `[x]` |
...
### 101.3 Neo4j Advisor Node Separation `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Advisor Graph Service | `services/neo4j/advisor_graph.py` | `[x]` |
| Type Separator | `services/compliance/advisor_type_separator.py` | `[x]` |

---

### 101.4 Kickback Revenue Validator `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Kickback Validator | `services/compliance/kickback_validator.py` | `[x]` |
| Revenue Analyzer | `services/compliance/revenue_analyzer.py` | `[x]` |
...
### 101.5 AUM Fee Constraint Mapping `[x]`
...
| Component | File Path | Status |
|-----------|-----------|--------|
| Fee Mapper | `services/compliance/fee_mapper.py` | `[x]` |
| AUM Calculator | `services/aum_calculator.py` | `[x]` |
...
|-------------|--------|--------------|
| 101.1 Advisor Table | `[x]` | `[ ]` |
| 101.2 COIS Calculator | `[x]` | `[ ]` |
| 101.3 Neo4j Advisor Types | `[x]` | `[ ]` |
| 101.4 Kickback Validator | `[x]` | `[ ]` |
| 101.5 AUM Fee Mapping | `[x]` | `[ ]` |
...
|---------|-------------|--------|
| `python cli.py advisor-list` | List all advisors | `[x]` |
| `python cli.py advisor-cois <id>` | Calculate COIS score | `[x]` |
| `python cli.py advisor-compliance <id>` | Run compliance check | `[x]` |
