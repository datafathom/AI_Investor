...
const EstateDashboard = () => {
    ...
    const estateStats = [
        { label: 'Total Estate Value', value: 4850000, prefix: '$', status: 'positive' },
        { label: 'Beneficiaries', value: 6, status: 'neutral' },
        { label: 'Trusts Active', value: 3, status: 'positive' },
        { label: 'Next Check-In', value: '14 days', status: 'neutral' }
    ];
        ...
        <div className="estate-dashboard-page p-6 h-full overflow-y-auto bg-slate-950">
            <header className="mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <Badge count="Protected" variant="success" pulse />
                </div>
                ...
                <div key="switch" style={{ borderRadius: '12px', overflow: 'hidden' }}>
                    <GlassCard variant="elevated" status="success" hoverable={false} className="h-full">
                        <div className="flex justify-between items-center mb-3">
                            ...
                            <Badge count="Armed" variant="success" />
                        </div>
                        <DeadMansSwitch />
                    </GlassCard>
                </div>
                ...
                <div key="beneficiary" style={{ borderRadius: '12px', overflow: 'hidden' }}>
                    <GlassCard variant="default" hoverable={false} className="h-full">
                        <div className="flex justify-between items-center mb-3">
                            ...
                            <Badge count="6 Verified" variant="info" />
                        </div>
                        <BeneficiaryMap />
                    </GlassCard>
                </div>
