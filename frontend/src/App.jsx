...
const AdvancedPortfolioAnalytics = lazy(
  () => import("./pages/AdvancedPortfolioAnalytics"),
); //
const NewsSentimentDashboard = lazy(
  () => import("./pages/NewsSentimentDashboard"),
); //
const WatchlistsAlertsDashboard = lazy(
  () => import("./pages/WatchlistsAlertsDashboard"),
); //
const AIPredictionsDashboard = lazy(
  () => import("./pages/AIPredictionsDashboard"),
); //
const AIAssistantDashboard = lazy(() => import("./pages/AIAssistantDashboard")); //
const PortfolioOptimizationDashboard = lazy(
  () => import("./pages/PortfolioOptimizationDashboard"),
); //
const AdvancedRiskDashboard = lazy(
  () => import("./pages/AdvancedRiskDashboard"),
); //
const TaxOptimizationDashboard = lazy(
  () => import("./pages/TaxOptimizationDashboard"),
); //
const FinancialPlanningDashboard = lazy(
  () => import("./pages/FinancialPlanningDashboard"),
); //
const RetirementPlanningDashboard = lazy(
  () => import("./pages/RetirementPlanningDashboard"),
); //
const BudgetingDashboard = lazy(() => import("./pages/BudgetingDashboard")); //
const OptionsStrategyDashboard = lazy(
  () => import("./pages/OptionsStrategyDashboard"),
); //
const PaperTradingDashboard = lazy(
  () => import("./pages/PaperTradingDashboard"),
); //
const AlgorithmicTradingDashboard = lazy(
  () => import("./pages/AlgorithmicTradingDashboard"),
); //
const EstatePlanningDashboard = lazy(
  () => import("./pages/EstatePlanningDashboard"),
); //
const BillPaymentDashboard = lazy(() => import("./pages/BillPaymentDashboard")); //
const CreditMonitoringDashboard = lazy(
  () => import("./pages/CreditMonitoringDashboard"),
); //
const ResearchReportsDashboard = lazy(
  () => import("./pages/ResearchReportsDashboard"),
); //
const SocialTradingDashboard = lazy(
  () => import("./pages/SocialTradingDashboard"),
); //
const CommunityForumsDashboard = lazy(
  () => import("./pages/CommunityForumsDashboard"),
); //
const EducationPlatformDashboard = lazy(
  () => import("./pages/EducationPlatformDashboard"),
); //
const AdvancedChartingDashboard = lazy(
  () => import("./pages/AdvancedChartingDashboard"),
); //
const AdvancedOrdersDashboard = lazy(
  () => import("./pages/AdvancedOrdersDashboard"),
); //
const EnterpriseDashboard = lazy(() => import("./pages/EnterpriseDashboard")); //
const InstitutionalToolsDashboard = lazy(
  () => import("./pages/InstitutionalToolsDashboard"),
); //
const MasterOrchestrator = lazy(() => import("./pages/MasterOrchestrator")); //
const SocialClassMaintenance = lazy(
  () => import("./pages/SocialClassMaintenance"),
); //
...
const SentinelStrategyDashboard = lazy(
  () => import("./pages/SentinelStrategyDashboard"),
);
...
const MiddlewarePipeline = lazy(
  () => import("./pages/admin/MiddlewarePipeline"),
);
...
const DeploymentController = lazy(
  () => import("./pages/admin/DeploymentController"),
);
...
const FeatureFlagManager = lazy(
  () => import("./pages/admin/FeatureFlagManager"),
);
const EnvironmentSettings = lazy(
  () => import("./pages/admin/EnvironmentSettings"),
);
const ForcedSellerMonitor = lazy(
  () => import("./pages/data-scientist/ForcedSellerMonitor"),
);
const WhaleFlowTerminal = lazy(
  () => import("./pages/data-scientist/WhaleFlowTerminal"),
);
const TechnicalIndicatorsPage = lazy(
  () => import("./pages/data-scientist/TechnicalIndicatorsPage"),
);
const Rule144CompliancePage = lazy(
  () => import("./pages/legal/Rule144CompliancePage"),
);
const DataPipelineManager = lazy(
  () => import("./pages/admin/DataPipelineManager"),
);
const APIConnectorHub = lazy(() => import("./pages/admin/APIConnectorHub"));
const ExternalDataSources = lazy(
  () => import("./pages/admin/ExternalDataSources"),
);
const WebhookReceiver = lazy(() => import("./pages/admin/WebhookReceiver"));
const DataQualityDashboard = lazy(
  () => import("./pages/admin/DataQualityDashboard"),
);
const NewsAggregator = lazy(() => import("./pages/hunter/NewsAggregator"));
const SocialSentimentRadar = lazy(
  () => import("./pages/data-scientist/SocialSentimentRadar"),
);
const SocialTradingFeed = lazy(
  () => import("./pages/hunter/SocialTradingFeed"),
);
const RumorMill = lazy(() => import("./pages/hunter/RumorMill"));
const ResearchWorkspace = lazy(
  () => import("./pages/data-scientist/ResearchWorkspace"),
);
const FactorAnalysisSuite = lazy(
  () => import("./pages/data-scientist/FactorAnalysisSuite"),
);
const FundamentalScanner = lazy(
  () => import("./pages/data-scientist/FundamentalScanner"),
);
const QuantBacktestLab = lazy(
  () => import("./pages/data-scientist/QuantBacktestLab"),
);
const AdvancedChartBuilder = lazy(
  () => import("./pages/data-scientist/AdvancedChartBuilder"),
);
const HeatmapGenerator = lazy(
  () => import("./pages/data-scientist/HeatmapGenerator"),
);
const AgentFleetOverview = lazy(
  () => import("./pages/admin/AgentFleetOverview"),
);
...
const DebateHistory = lazy(
  () => import("./pages/data-scientist/DebateHistory"),
);
const OrderManagementSystem = lazy(
  () => import("./pages/admin/OrderManagementSystem"),
);
...
const ReconciliationDashboard = lazy(
  () => import("./pages/admin/ReconciliationDashboard"),
);
...
const TacticalCommandCenter = lazy(
  () => import("./pages/admin/TacticalCommandCenter"),
);
...
const DiscrepancyResolution = lazy(
  () => import("./pages/admin/DiscrepancyResolution"),
);
...
const TaxLiabilityDashboard = lazy(
  () => import("./pages/admin/TaxLiabilityDashboard"),
);
...
const PhilanthropyCenter = lazy(
  () => import("./pages/admin/PhilanthropyCenter"),
);
...
const BlackSwanGenerator = lazy(
  () => import("./pages/admin/BlackSwanGenerator"),
);
  ...
  useEffect(() => {
    const loadComponent = async () => {
      ...
      try {
        ...
        let match = Object.keys(workstationModules).find(
          (key) =>
        ...
        if (!match) {
          ...
          match = Object.keys(workstationModules).find(
            (key) =>
              key.includes(`/${deptSlug}/`) &&
              (key.endsWith(`/${combinedName}.jsx`) ||
                key
                  .toLowerCase()
                  .endsWith(`/${combinedName.toLowerCase()}.jsx`)),
          );
        }
        ...
        if (!match) {
          match = Object.keys(workstationModules).find(
            (key) =>
              key.includes(`/${deptSlug}/`) &&
              key.toLowerCase().endsWith(`/${subPascal.toLowerCase()}.jsx`),
          );
        }
        ...
        if (match) {
          ...
          console.warn(
            `Workstation not found for path: ${deptSlug}/${subSlug}. Checked: ${subPascal}.jsx, ${deptPascal}${subPascal}.jsx`,
          );
        }
      } catch (err) {
  ...
  if (!Component)
    return (
      <div className="flex items-center justify-center min-h-screen bg-black font-mono text-red-500">
        <div>
          ERROR: WORKSTATION_NOT_FOUND // PATH: /{deptSlug}/{subSlug}
        </div>
      </div>
    );
...
const VennIntersectionView = lazy(
  () => import("./pages/Departments/VennIntersectionView"),
);
const OrchestratorPage = lazy(
  () => import("./pages/Departments/OrchestratorPage"),
);

const ArchitectPage = lazy(() => import("./pages/Departments/ArchitectPage"));
const DataScientistPage = lazy(
  () => import("./pages/Departments/DataScientistPage"),
);
...
const FrontOfficePage = lazy(
  () => import("./pages/Departments/FrontOfficePage"),
);
const HistorianPage = lazy(() => import("./pages/Departments/HistorianPage"));
const StressTesterPage = lazy(
  () => import("./pages/Departments/StressTesterPage"),
);
...
const DeveloperPlatformDashboard = lazy(
  () => import("./pages/DeveloperPlatformDashboard"),
); //
...
function AppContent() {
  ...
  const departmentData = useDepartmentStore((state) =>
    currentDept ? state.departments[currentDept.id] : null,
  );
  ...
  const { isKillMFAOpen, setKillMFAOpen, triggerKillSwitch } =
    useTaskbarStore();
  ...
  useEffect(() => {
    ...
    presenceService.on("trade:fill", (data) => {
      notify({
        title: "ORDER FILLED",
        body: `${data.symbol} ${data.side} ${data.quantity} @ ${data.price}`,
        type: "success",
      });
    });
    ...
    if (useWindowStore.getState().windows.length === 0) {
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            ...
            <p>
              Window Manager: <strong>Active</strong>
            </p>
            <p>
              Taskbar: <strong>Active</strong>
            </p>
            <p>
              Agents Online: <strong>12/12</strong>
            </p>
          </div>
        ),
      });
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            ...
            <p>
              S&P 500: <span style={{ color: "#00ff88" }}>+1.42%</span>
            </p>
            <p>
              VIX: <span style={{ color: "#ffc107" }}>13.42</span>
            </p>
            <p>
              Active Alerts: <strong>3</strong>
            </p>
          </div>
        ),
      });
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            ...
            <p>
              Total Value: <span style={{ color: "#00ff88" }}>$2,847,320</span>
            </p>
            <p>
              Today's P&L:{" "}
              <span style={{ color: "#00ff88" }}>+$12,450 (+0.44%)</span>
            </p>
            <p>
              Positions: <strong>24</strong>
            </p>
          </div>
        ),
      });
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            <h3>📰 Breaking News</h3>
            <p style={{ borderBottom: "1px solid #333", paddingBottom: 8 }}>
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            <h3>🧬 Strategy Lab</h3>
            <p>
              Active Strategies: <strong>3</strong>
            </p>
            <p>
              Backtesting:{" "}
              <span style={{ color: "#00f2ff" }}>Momentum Alpha v2.1</span>
            </p>
            <p>
              Win Rate: <span style={{ color: "#00ff88" }}>67.4%</span>
            </p>
          </div>
        ),
      });
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            <h3>📊 Analytics</h3>
            <p>
              Sharpe Ratio: <strong>1.82</strong>
            </p>
            <p>
              Max Drawdown: <span style={{ color: "#ffc107" }}>-8.2%</span>
            </p>
            <p>
              Alpha: <span style={{ color: "#00ff88" }}>+4.1%</span>
            </p>
          </div>
        ),
      });
      ...
      addWindow({
        ...
        component: () => (
          <div style={{ padding: 20, color: "white" }}>
            <h3>👁️ Watchlist</h3>
            <p>
              AAPL: <span style={{ color: "#00ff88" }}>$189.42 ↑</span>
            </p>
            <p>
              TSLA: <span style={{ color: "#ff4757" }}>$241.05 ↓</span>
            </p>
            <p>
              MSFT: <span style={{ color: "#00ff88" }}>$378.91 ↑</span>
            </p>
            <p>
              GOOGL: <span style={{ color: "#ffc107" }}>$142.33 →</span>
            </p>
          </div>
        ),
      });
  ...
  const handleMenuAction = useCallback(
    (action) => {
      ...
      switch (action) {
        ...
        case "nav-special-scrum":
          navigate("/special/scrum");
          break;
        case "nav-special-mobile":
          navigate("/special/mobile");
          break;
        case "nav-special-vr":
          navigate("/special/vr");
          break;
        case "nav-special-mission-control":
          navigate("/special/mission-control");
          break;
        case "nav-special-terminal":
          navigate("/special/terminal");
          break;
        case "nav-special-political":
          navigate("/special/political");
          break;
        case "nav-special-strategy":
          navigate("/special/strategy");
          break;
        case "nav-special-debate":
          navigate("/special/debate");
          break;
        case "nav-special-missions":
          navigate("/special/missions");
          break;
        case "nav-special-paper":
          navigate("/special/paper");
          break;
        case "nav-special-zen":
          navigate("/special/zen");
          break;
        case "nav-brokerage":
          navigate("/strategist/brokerage");
          break;

        // --- Agent Departments (Phase 2/3) ---
        case "nav-scrum-master":
          navigate("/special/scrum");
          break;
        // nav-dept-ID cases removed in favor of unified nav-path: handling
    ...
    <GlobalErrorBoundary>
      <div className={`app-shell ${isDark ? "dark" : "light"}`}>
        <AuthGuard onShowLogin={() => setIsAuthModalOpen(true)}>
          ...
          <main
            className={`institutional-os-container ${isOSStylePage ? "os-bleed" : ""}`}
          >
            ...
            <div
              className={isOSStylePage ? "route-content-os" : "route-content"}
            >
              <Suspense fallback={<DashboardSkeleton />}>
                ...
                <Routes>
                  ...
                  <Route
                    path="/orchestrator/terminal"
                    element={<Navigate to="/special/terminal" replace />}
                  />
                  <Route
                    path="/orchestrator/mission-control"
                    element={<Navigate to="/special/mission-control" replace />}
                  />
                  <Route
                    path="/orchestrator/zen"
                    element={<Navigate to="/special/zen" replace />}
                  />
                  <Route
                    path="/orchestrator"
                    element={<Navigate to="/dept/orchestrator" replace />}
                  />
                  <Route
                    path="/architect"
                    element={<Navigate to="/dept/architect" replace />}
                  />
                  <Route
                    path="/analyst"
                    element={<Navigate to="/dept/data-scientist" replace />}
                  />
                  <Route
                    path="/trader"
                    element={<Navigate to="/dept/trader" replace />}
                  />
                  <Route
                    path="/strategist"
                    element={<Navigate to="/dept/strategist" replace />}
                  />
                  <Route
                    path="/guardian"
                    element={<Navigate to="/dept/guardian" replace />}
                  />
                  <Route
                    path="/marketing"
                    element={<Navigate to="/dept/hunter" replace />}
                  />
                  <Route
                    path="/hunter"
                    element={<Navigate to="/dept/hunter" replace />}
                  ...
                  <Route
                    path="/legal"
                    element={<Navigate to="/dept/lawyer" replace />}
                  />
                  <Route
                    path="/pioneer"
                    element={<Navigate to="/dept/data-scientist" replace />}
                  ...
                  {/* --- Sub-Module Routes --- */}
                  <Route
                    path="/orchestrator/graph"
                    element={<MasterOrchestrator />}
                  />
                  ...
                  <Route
                    path="/architect/integrations"
                    element={<IntegrationsDashboard />}
                  />
                  <Route
                    path="/architect/dev-platform"
                    element={<DeveloperPlatformDashboard />}
                  />
                  ...
                  <Route
                    path="/analyst/political"
                    element={<PoliticalAlpha />}
                  />
                  <Route
                    path="/analyst/strategy"
                    element={<StrategyDistillery />}
                  />
                  <Route path="/analyst/macro" element={<MacroDashboard />} />
                  {/* Removed: <Route path="/analyst/assistant" element={<AIAssistantDashboard />} /> */}
                  <Route
                    path="/analyst/sentinel"
                    element={<SentinelStrategyDashboard />}
                  />

                  <Route
                    path="/data-scientist/predictions"
                    element={<AIPredictionsDashboard />}
                  />
                  <Route
                    path="/data-scientist/training"
                    element={<MLTrainingDashboard />}
                  />
                  <Route
                    path="/data-scientist/assistant"
                    element={<AIAssistantDashboard />}
                  />
                  <Route
                    path="/data-scientist/autocoder"
                    element={<AutoCoderDashboard />}
                  />
                  <Route
                    path="/data-scientist/sandbox"
                    element={<AutoCoderSandbox />}
                  />
                  <Route path="/data-scientist/vr" element={<VRCockpit />} />
                  <Route
                    path="/data-scientist/debate"
                    element={<DebateRoom />}
                  />
                  ...
                  <Route
                    path="/trader/options"
                    element={<OptionsStrategyDashboard />}
                  />
                  <Route
                    path="/trader/advanced-orders"
                    element={<AdvancedOrdersDashboard />}
                  />
                  <Route
                    path="/trader/algorithmic"
                    element={<AlgorithmicTradingDashboard />}
                  />
                  <Route
                    path="/trader/paper"
                    element={<PaperTradingDashboard />}
                  />
                  <Route
                    path="/trader/charting"
                    element={<AdvancedChartingDashboard />}
                  />
                  <Route
                    path="/trader/options-analytics"
                    element={<OptionsAnalytics />}
                  />

                  <Route
                    path="/strategist/net-worth"
                    element={<PortfolioManagement />}
                  />
                  <Route
                    path="/strategist/analytics"
                    element={<AdvancedPortfolioAnalytics />}
                  />
                  <Route
                    path="/strategist/optimization"
                    element={<PortfolioOptimizationDashboard />}
                  />
                  <Route
                    path="/strategist/attribution"
                    element={<PortfolioAttribution />}
                  />
                  <Route
                    path="/strategist/backtest"
                    element={<BacktestPortfolio />}
                  />
                  <Route
                    path="/strategist/brokerage"
                    element={<BrokerageAccount />}
                  />
                  <Route
                    path="/strategist/crypto"
                    element={<CryptoDashboard />}
                  />
                  <Route
                    path="/strategist/fixed-income"
                    element={<FixedIncomeDashboard />}
                  />
                  <Route
                    path="/strategist/assets"
                    element={<AssetsDashboard />}
                  />
                  <Route
                    path="/strategist/corporate"
                    element={<CorporateDashboard />}
                  />
                  <Route
                    path="/strategist/impact"
                    element={<ImpactDashboard />}
                  />
                  <Route
                    path="/strategist/scm"
                    element={<SocialClassMaintenance />}
                  />
                  <Route
                    path="/strategist/estate"
                    element={<EstatePlanningDashboard />}
                  />
                  <Route
                    path="/strategist/retirement"
                    element={<RetirementPlanningDashboard />}
                  />
                  <Route
                    path="/strategist/budgeting"
                    element={<BudgetingDashboard />}
                  />
                  <Route
                    path="/strategist/financial"
                    element={<FinancialPlanningDashboard />}
                  />

                  <Route
                    path="/hunter/news"
                    element={<NewsSentimentDashboard />}
                  />
                  <Route
                    path="/hunter/social"
                    element={<SocialTradingDashboard />}
                  />
                  <Route
                    path="/hunter/forums"
                    element={<CommunityForumsDashboard />}
                  />
                  <Route
                    path="/hunter/education"
                    element={<EducationPlatformDashboard />}
                  />
                  <Route
                    path="/hunter/marketplace"
                    element={<MarketplaceDashboard />}
                  />
                  <Route
                    path="/hunter/reports"
                    element={<ResearchReportsDashboard />}
                  />
                  <Route
                    path="/hunter/alerts"
                    element={<WatchlistsAlertsDashboard />}
                  />
                  ...
                  />
                  <Route
                    path="/legal/144a-compliance"
                    element={<Rule144CompliancePage />}
                  />
                  <Route path="/legal/audit" element={<AuditDashboard />} />
                  <Route
                    path="/legal/scenarios"
                  ...
                  <Route
                    ...
                    element={
                      <AuthGuard
                        onShowLogin={() => setIsAuthModalOpen(true)}
                        requiredRole="admin"
                      >
                        <AdminPage />
                      </AuthGuard>
                    ...
                    element={
                      ...
                      >
                        <Routes>
                          ...
                          <Route
                            path="event-bus"
                            element={<EventBusMonitor />}
                          />
                          <Route path="storage" element={<StorageManager />} />
                          <Route
                            path="graph-browser"
                            element={<GraphBrowser />}
                          />
                          <Route path="logs" element={<LogViewer />} />
                          <Route
                            path="health"
                            element={<ServiceHealthGrid />}
                          />
                          <Route
                            path="middleware"
                            element={<MiddlewarePipeline />}
                          />
                          <Route
                            path="monitoring"
                          ...
                          />
                          <Route
                            path="data-pipeline-manager"
                            element={<DataPipelineManager />}
                          />
                          <Route
                            path="connections"
                            element={<APIConnectorHub />}
                          />
                          <Route
                            path="external-data"
                            element={<ExternalDataSources />}
                          />
                          <Route
                            path="webhooks"
                          ...
                          <Route
                            path="agents/fleet"
                            element={<AgentFleetOverview />}
                          />
                          <Route
                            path="agents/tasks"
                            element={<AgentTaskQueue />}
                          />
                          <Route
                            path="agents/logs"
                            element={<AgentLogsViewer />}
                          />
                          <Route
                          ...
                          <Route
                            ...
                            element={<ExecSummaryPage />}
                          />
                          <Route
                            path="crash-simulator"
                            element={<CrashSimulator />}
                          />
                          <Route
                            path="tactical-command-center"
                            element={<TacticalCommandCenter />}
                          />
                          <Route
                            path="pricing-verifier"
                            element={<PricingVerifier />}
                          />
                          <Route
                            path="source-reputation"
                            element={<SourceReputation />}
                          />
                          <Route
                            path="quality-incidents"
                            element={<QualityIncidents />}
                          />
                          <Route
                            path="discrepancy-resolution"
                            element={<DiscrepancyResolution />}
                          />
                          <Route
                          ...
                          <Route
                            path="tax-harvester"
                            element={<TaxHarvester />}
                          />
                          <Route
                            path="tax-liability"
                            element={<TaxLiabilityDashboard />}
                          />
                          <Route
                          ...
                          <Route
                            ...
                            element={<DonationManager />}
                          />
                          <Route
                            path="philanthropy-center"
                            element={<PhilanthropyCenter />}
                          />
                          <Route
                            path="succession-modeler"
                            element={<SuccessionModeler />}
                          />
                          <Route
                            path="/estate-visualizer"
                            element={<EstateVisualizer />}
                          />
                          <Route
                            path="gifting-optimizer"
                            element={<GiftingOptimizer />}
                          />
                          <Route
                            path="black-swan-generator"
                            element={<BlackSwanGenerator />}
                          />
                          <Route
                            path="war-game-arena"
                            element={<WarGameArena />}
                          />
                          <Route
                            path="robustness-lab"
                            element={<RobustnessLab />}
                          />
                        </Routes>
                      </AuthGuard>
                    }
                  ...
                  <Route
                    ...
                    element={<SocialSentimentRadar />}
                  />
                  <Route
                    path="/hunter/social-trading"
                    element={<SocialTradingFeed />}
                  />
                  <Route path="/hunter/rumors" element={<RumorMill />} />
                  <Route
                    path="/data-scientist/forced-sellers"
                    element={<ForcedSellerMonitor />}
                  />
                  <Route
                    path="/data-scientist/whale-flow"
                    element={<WhaleFlowTerminal />}
                  />
                  <Route
                    path="/data-scientist/indicators"
                    element={<TechnicalIndicatorsPage />}
                  />
                  <Route
                    path="/data-scientist/research-workspace"
                    element={<ResearchWorkspace />}
                  />
                  <Route
                    path="/data-scientist/factor-analysis"
                    element={<FactorAnalysisSuite />}
                  />
                  <Route
                    path="/data-scientist/fundamental-scanner"
                    element={<FundamentalScanner />}
                  />
                  <Route
                    path="/data-scientist/quant-backtest"
                    element={<QuantBacktestLab />}
                  />
                  <Route
                    path="/data-scientist/advanced-charting"
                    element={<AdvancedChartBuilder />}
                  />
                  <Route
                    path="/data-scientist/heatmap"
                  ...
                  />
                  <Route
                    path="/data-scientist/debate-history"
                    element={<DebateHistory />}
                  />
                  <Route
                  ...
                  />
                  <Route
                    path="/autocoder/dashboard"
                    element={<AutoCoderDashboard />}
                  />
                  <Route
                    path="/admin/executive-summary"
                    element={<Navigate to="/admin/executive-summary" replace />}
                  />
                  ...
                  <Route
                    path="/special/mission-control"
                    element={<MissionControl />}
                  />
                  <Route
                    path="/special/homeostasis"
                    element={<Homeostasis />}
                  />
                  <Route
                    path="/special/terminal"
                    element={
                      <TerminalWorkspace
                        handleViewSource={() => {}}
                        globalLock={globalLock}
                  ...
                  />
                  <Route
                    path="/special/political"
                    element={<PoliticalAlpha />}
                  />
                  <Route
                    path="/special/strategy"
                    element={<StrategyDistillery />}
                  />
                  ...
                  <Route
                    path="/special/venn"
                    element={<VennIntersectionView />}
                  />
                  <Route
                    path="/missions"
                    element={<Navigate to="/special/missions" replace />}
                  />

                  {/* --- Agent Department Routes --- */}
                  <Route
                    path="/dept"
                    element={<Navigate to="/special/scrum" replace />}
                  />
                  <Route
                    path="/scrum"
                    element={<Navigate to="/special/scrum" replace />}
                  ...
                  <Route
                    path="/dept/front-office"
                    element={<FrontOfficePage />}
                  />
                  <Route path="/dept/historian" element={<HistorianPage />} />
                  <Route
                    path="/dept/stress-tester"
                    element={<StressTesterPage />}
                  />
                  ...
                  <Route
                    path="/:deptSlug/:subSlug"
                    element={<DynamicWorkstation />}
                  />
                  <Route
                    path="/dept/:deptSlug/:subSlug"
                    element={<DynamicWorkstation />}
                  />
                  ...
                  <Route
                    ...
                    element={
                      <div className="p-8 text-white">
                        ...
                        <p>Update your institutional identity.</p>
                      </div>
                    }
                  />
                  <Route
                    ...
                    element={
                      <div className="p-8 text-white">
                        ...
                        <p>Master the terminal via hotkeys.</p>
                      </div>
                    }
                  />
                  ...
                  <Route
                    path="/"
                    element={<Navigate to="/orchestrator/terminal" replace />}
                  />
            ...
            {/* End route-content wrapper */}
            {/* 100px buffer only for standard scrollable pages */}
            {!isOSStylePage && (
              <div
                className="global-scroll-buffer"
        ...
        <MFAVerificationModal
          ...
          onSuccess={async (mfa_code) => {
            ...
            try {
              ...
              notify({
                title: "SYSTEM HALTED",
                body: "Kill switch signal broadcasted",
                type: "critical",
              });
            } catch (e) {
              notify({
                title: "KILL SWITCH ERROR",
                body: "Failed to notify backend",
                type: "error",
              });
            }
          }}
        ...
        <FrozenOverlay
          ...
          onUnlock={() => setIsSystemFrozen(false)}
        />
          ...
          <Suspense fallback={null}>
            <OnboardingFlow
              onComplete={(userData) => {
                ...
                // Save to API
                apiClient
                  .post("/onboarding/complete", { preferences })
                  .catch(console.error);
              }}
              onSkip={() => {
                setShowOnboarding(false);
